...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input__systemUseremployeeNameempName'), 'z')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/li_Chenzira Chuki'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input__systemUseruserName'), 'azertyu')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input__systemUserpassword'), 'Sq3GCBP2dr+VXXRKjnEpGQ==')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_OrangeHRM/input__systemUserconfirmPassword'), 'Sq3GCBP2dr+VXXRKjnEpGQ==')
