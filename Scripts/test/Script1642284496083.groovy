...
WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input__systemUseremployeeNameempName'), 't')

WebUI.click(findTestObject('Object Repository/Page_OrangeHRM/li_Anthony Nolan'))

WebUI.setText(findTestObject('Object Repository/Page_OrangeHRM/input__systemUseruserName'), 'jlidiz')
